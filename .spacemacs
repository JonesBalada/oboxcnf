...
(defun coelhotopetudo/zmatudo (arg)
  (interactive "P")
  (setq arquivo "/git/18-dezoito/TODOs.org")
  (find-file arquivo)
  (mark-whole-buffer)
  (org-sort-entries nil ?t nil nil nil nil)
  (save-buffer)
  (magit-stage-file arquivo)
...
;; (defun coelhotopetudo/clh-insert-char (char count)
;;   (interactive "c\np")
...
before packages are loaded."
  ...
  ;; comentado essa parte para ver se nao eh isso q estah ocupando memoria
  ;; C-i <> tab https://emacs.stackexchange.com/a/17510
  ;; (define-key input-decode-map "\C-i" [C-i])
  ;; (define-key evil-normal-state-map (kbd "\C-i") 'coelhotopetudo/clh-insert-char)
  ;; (evil-define-key 'normal org-mode-map (kbd "\C-i") 'coelhotopetudo/clh-insert-char)
...
;;             ))
  ...
  ;; created a cada todo igual ao orgzly, mas parece coloca tb no yy
  (add-hook 'org-capture-before-finalize-hook 'org-expiry-insert-created)

  ;; nao funfou somente o setq, vou reiniciar para ver se vai funfar somente no todo o do before
  ;; https://stackoverflow.com/a/45951872
  ;; (setq org-treat-insert-todo-heading-as-state-change t)

  ;; nao abrir pdf no emacs
  ;; https://emacs.stackexchange.com/questions/22736/org-mode-how-to-disable-automatic-doc-view-on-emacs-25
  ;; nao deu certo, parece abrir no fundamental  com essa linha (add-to-list 'auto-mode-alist '("\\.pdf\\'" . "evince %s"))
